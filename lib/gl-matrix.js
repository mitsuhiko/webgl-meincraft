...
(function(_outer) {
    ...
    var _global = (typeof(exports) != 'undefined') ? global : _outer;
 ...
 *
 * Params:
 * vec - vec3 to calculate squared length of
 *
 * Returns:
 * Length of vec
 */
vec3.norm2 = function (vec) {
    var x = vec[0], y = vec[1], z = vec[2];
    return x * x + y * y + z * z;
};
...
/*
 * vec4.toVec3
 * Converts a vec4 to a vec3 by dividing components 1-3 by 4.
 *
 * Params:
 ...
 *
 * Params:
 * vec - vec4 to calculate squared length of
 *
 * Returns:
 * Length of vec
 */
vec4.norm2 = function (vec) {
    var x = vec[0], y = vec[1], z = vec[2], w = vec[3];
